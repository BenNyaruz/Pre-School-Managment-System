...
{
    public partial class Uniform_Related_Expenses_Form : Form
    {
        ...
        public Uniform_Related_Expenses_Form()
        {
            InitializeComponent();
            Expense_Date_dateTimePicker.Value = DateTime.Now;
        }

        private void Uniform_Related_Expenses_Form_Load(object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                command.CommandText = "select * from [Uniform_Directed_Expenses_tbl]";
        ...
        private void School_Term_txt_SelectedIndexChanged(object sender, System.EventArgs e)
        {
            ...
            try
            {
                string Uniform_Profit_Query = "Select [Total_Profit] FROM [Uniform_Managment_tbl] WHERE School_Term = '" + School_Term_txt.Text.Trim() + "'";
                ...
                {
                    Uniform_Profit_txt.Text = Uniform_Profit_Tbl.Rows[(Uniform_Profit_Tbl.Rows.Count) - 1][0].ToString();
                    Total_Profit_Before_Expense = Convert.ToDecimal(Uniform_Profit_txt.Text);
                }
            }
            catch (Exception ex)
            {
        ...
        private void Add_Expense_btn_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                string Uniform_Query = "Select [Total_Cash_Expenses],[Total_Transfer_Expenses],[Total_Bank_Expenses],[Total_Other_Expenses],[Total_Expenses],[Total_Profit] FROM [Uniform_Managment_tbl] WHERE School_Term = '" + School_Term_txt.Text.Trim() + "'";
                ...
                Total_Profit_Before_Expense = Convert.ToDecimal(Uniform_Tbl.Rows[(Uniform_Tbl.Rows.Count) - 1][5].ToString());
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            ...
            if (Cash_radioButton.Checked == true)
            {
                ...
                try
                {
                    ...
                    Total_Cash_Expense_Command.CommandText = "update [Uniform_Managment_tbl] set Total_Cash_Expenses = '" + Total_Cash_Expenses_After_Expense + "' WHERE School_Term = '" + School_Term_txt.Text.Trim() + "'";
                    ...
                    Total_Expense_Command.CommandText = "update [Uniform_Managment_tbl] set Total_Expenses = '" + Total_Expense_After_Expense + "' WHERE School_Term = '" + School_Term_txt.Text.Trim() + "'";
                    ...
                    Total_Profit_Command.CommandText = "update [Uniform_Managment_tbl] set Total_Profit = '" + Total_Profit_After_Expense + "' WHERE School_Term = '" + School_Term_txt.Text.Trim() + "'";
            ...
            else if (Transfer_radioButton.Checked == true)
            {
                ...
                try
                {
                    ...
                    Total_Transfer_Expense_Command.CommandText = "update [Uniform_Managment_tbl]  set Total_Transfer_Expenses = '" + Total_Transfer_Expenses_After_Expense + "' WHERE School_Term = '" + School_Term_txt.Text.Trim() + "'";
            ...
            else if (Bank_radioButton.Checked == true)
            {
                ...
                try
                {
                    ...
                    Total_Bank_Expense_Command.CommandText = "update [Uniform_Managment_tbl] set Total_Bank_Expenses = '" + Total_Bank_Expenses_After_Expense + "' WHERE School_Term = '" + School_Term_txt.Text.Trim() + "'";
            ...
            else if (Other_radioButton.Checked == true)
            {
                ...
                try
                {
                    ...
                    Total_Other_Expense_Command.CommandText = "update [Uniform_Managment_tbl] set Total_Other_Expenses = '" + Total_Other_Expenses_After_Expense + "' WHERE School_Term = '" + School_Term_txt.Text.Trim() + "'";
            ...
            try
            {
                OleDbCommand Uniform_Command = new OleDbCommand
                {
                    ...
                    CommandText = "INSERT INTO [Uniform_Directed_Expenses_tbl] ([School_Term],[Uniform_Date],[Expense_Description],[Expense_Type],[Expense_Amount],[Accountant])" + "VALUES (?,?,?,?,?,?)"
                };
                Uniform_Command.Parameters.AddWithValue("@School_Term", School_Term_txt.Text.Trim());
                Uniform_Command.Parameters.AddWithValue("@Uniform_Date", Expense_Date_dateTimePicker.Text.Trim());
                Uniform_Command.Parameters.AddWithValue("@Expense_Description", Expense_Description_txt.Text.Trim());
                Uniform_Command.Parameters.AddWithValue("@Expense_Type", Expense_Method);
                Uniform_Command.Parameters.AddWithValue("@Expense_Amount", Expense_Amount_txt.Value);
            ...
            try
            {
                ...
                Table_Load_command.CommandText = "select * from [Uniform_Directed_Expenses_tbl]";
            ...
            Uniform_Profit_txt.Text = Total_Profit_After_Expense.ToString();
